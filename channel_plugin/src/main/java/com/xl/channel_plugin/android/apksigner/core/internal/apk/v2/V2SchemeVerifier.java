...
package com.xl.channel_plugin.android.apksigner.core.internal.apk.v2;


import com.xl.channel_plugin.android.apksigner.core.ApkVerifier;
import com.xl.channel_plugin.android.apksigner.core.apk.ApkUtils;
import com.xl.channel_plugin.android.apksigner.core.internal.util.ByteBufferDataSource;
import com.xl.channel_plugin.android.apksigner.core.internal.util.DelegatingX509Certificate;
import com.xl.channel_plugin.android.apksigner.core.internal.util.Pair;
import com.xl.channel_plugin.android.apksigner.core.internal.zip.ZipUtils;
...
public abstract class V2SchemeVerifier {
    ...
    private static void parseSigner(
        ...
        if (signaturesToVerify.isEmpty()) {
            result.addError(ApkVerifier.Issue.V2_SIG_NO_SUPPORTED_SIGNATURES);
            return;
        }
